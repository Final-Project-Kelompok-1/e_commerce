...
class AppFont {
  ...
  static TextStyle get paragraphLarge => GoogleFonts.poppins(
        fontSize: 16.sp,
        fontWeight: FontWeight.w400,
        color: Colors.black,
      );

  static TextStyle get paragraphLargeBold => GoogleFonts.poppins(
        fontSize: 16.sp,
        fontWeight: FontWeight.w700,
        color: Colors.black,
      );
  ...
  static TextStyle get paragraphMediumBold => GoogleFonts.poppins(
        fontSize: 14.sp,
        fontWeight: FontWeight.w700,
        color: Colors.black,
      );

  static TextStyle get paragraphSmall => GoogleFonts.poppins(
        fontSize: 12.sp,
        fontWeight: FontWeight.w400,
        color: Colors.black,
      );

  static TextStyle get paragraphSmallBold => GoogleFonts.poppins(
        fontSize: 12.sp,
        fontWeight: FontWeight.w700,
        color: Colors.black,
      );
  ...
  static TextStyle get componentLarge => GoogleFonts.poppins(
        fontSize: 16.sp,
        fontWeight: FontWeight.w600,
        color: Colors.black,
      );
  ...
  static TextStyle get componentMedium => GoogleFonts.poppins(
        fontSize: 14.sp,
        fontWeight: FontWeight.w400,
        color: Colors.black,
      );
